...
# Apache Tomcat 9 CIS Benchmark v1.2.0 - Sections 1 to 4
# Fully implemented enforcement script for controls 1.1 through 4.15
...
check_controls_v9() {
  ...
  echo "───────────────────────────────────────────────"
  REPORT="$dir/tomcat9_cis_compliance_report.txt"
  echo "Apache Tomcat 9 Compliance Report - $(date)" > "$REPORT"
